...
declare enum COLOR_MODE {}
declare enum ARC_MODE {}
declare enum ELLIPSE_MODE {}
declare enum RECT_MODE {
  CENTER = 'center'
}
declare enum STROKE_CAP {}
declare enum STROKE_JOIN {}
declare enum RENDERER {}
declare enum BLEND_MODE {}
declare enum BEGIN_KIND {}
declare enum END_MODE {}
declare enum IMAGE_MODE {}
declare enum FILTER_TYPE {}
declare enum ANGLE_MODE {}
declare enum HORIZ_ALIGN {}
declare enum VERT_ALIGN {}
declare enum THE_STYLE {}
declare enum GRAPHICS_RENDERER {}
